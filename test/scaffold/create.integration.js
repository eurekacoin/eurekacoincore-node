...
describe('#create', function() {
  ...
  before(function(done) {
    ...
    mkdirp(testDir, function(err) {
      ...
      mkdirp(testDir + '/.eurekacoin', function(err) {
        if (err) {
          throw err;
        }
        done();
  ...
  it('will create scaffold files', function() {
    create({
      ...
      var configPath = testDir + '/mynode/eurekacoincore-node.json';
      ...
      config.services.should.deep.equal(['eurekacoind', 'db', 'address', 'web']);
