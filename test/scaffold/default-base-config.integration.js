...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    eurekacoind.spawn.datadir.should.equal(home + '/.eurekacoin');
    eurekacoind.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/eurekacoind'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.eurekacoind.spawn.datadir.should.equal('./data2');
  });
});
