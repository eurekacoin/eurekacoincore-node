...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `eurekacoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ eurekacoincore-node add wallet-service');
      console.log('    $ eurekacoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ eurekacoincore-node remove wallet-service');
      console.log('    $ eurekacoincore-node remove insight-api');
      console.log();
    });
